        ...
        <div className={`w-[18rem] h-[40vh] flex items-center flex-col absolute overflow-hidden top-[20rem] bg-white pin-menu ${pinCreationToggle ? 'pin-menu-open' : ''} ${pinCreationToggle ? 'border' : ''}`}>
            ...
            <form className="flex flex-col">
                <div className='mt-2 flex flex-row border border-green-600 items-center rounded-lg'>
                    ...
                    <input placeholder="Enter title..." className="focus:outline-none"></input>
                </div>
                <div className='mt-3 mb-3 flex flex-row border border-green-600 items-center rounded-lg'>
                    ...
                    <input placeholder="Enter description..." className="focus:outline-none"></input>
                </div>
                <button onClick={() => {
                    togglePinCreation(); handlePinSubmit();
                    }} className='bg-green-600 border-green-600 rounded-full ml-5 mr-5 p-2 mb-4 text-white text-lg hover:bg-white hover:border hover:shadow-md hover:scale-105 hover:text-green-600 transition-all' >Submit</button>
                </form>
        </div>
    )
}